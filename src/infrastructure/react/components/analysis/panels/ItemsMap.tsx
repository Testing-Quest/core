    ...
    >
      <ResponsiveContainer width='90%' height={500}>
        <ScatterChart margin={{ bottom: 15 }}>
          ...
          {/* Letras Horizontales */}
          <text x='98%' y='74%' style={{ fontSize: 16, fill: '#000000' }}>
            4
          </text>
          <text x='98%' y='45%' style={{ fontSize: 16, fill: '#000000' }}>
            5
          </text>
          <text x='98%' y='35.4%' style={{ fontSize: 16, fill: '#000000' }}>
            3
          </text>
          <text x='98%' y='28.5%' style={{ fontSize: 16, fill: '#000000' }}>
            2
          </text>
          <text x='98%' y='15%' style={{ fontSize: 16, fill: '#000000' }}>
            1
          </text>
          {/* Letras Verticales */}
          <text x='90%' y='90%' style={{ fontSize: 16, fill: '#000000' }}>
            A
          </text>
          <text x='71%' y='90%' style={{ fontSize: 16, fill: '#000000' }}>
            B
          </text>
          <text x='51.7%' y='90%' style={{ fontSize: 16, fill: '#000000' }}>
            C
          </text>
          <text x='32.6%' y='90%' style={{ fontSize: 16, fill: '#000000' }}>
            D
          </text>
          <text x='13.5%' y='90%' style={{ fontSize: 16, fill: '#000000' }}>
            E
          </text>
